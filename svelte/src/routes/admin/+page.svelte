    ...
    <div class="pure-g">
        <div class="pure-u-1-4">
            ...
            <!-- <form method="POST" action="?/XXXlistdata" use:enhance> -->
                ...
                <p><label for="entry">Select an option</label></p>
                <select name="entry" id="entry" bind:value={entryId}>
                    <option value="" selected="selected">Add new entry...</option>
        ...
        - this is a callback on success, that will suppress the client-side action of clearing the
    -->
            {#if entryId}

            <ItemEditForm {entryData} />
            ...
            <!-- <div class="pure-g form">
                <form action="?/update" method="POST" use:enhance={() => {
                    ...
                    <div class="pure-u-3-4"><p><input type="text" id="id" name="id" value="{entryData.id}" /><input type="text" name="title" id="title" value="{entryData.title}"></p></div>
                    <div class="pure-u-1-4"><p><label for="type" title="Is this item for 'maps' or 'snippets'?">Type</label></p></div>
                    <div class="pure-u-3-4"><p><input type="text" name="type" id="type" value="{entryData.type}"></p></div>
